...
| Name | Description |
| --- | --- |
| [Targeter](#targeter.targeter.Targeter) | targeter for automated EDA. |

### Targeter { #targeter.targeter.Targeter }
...
|---------------------------|------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
| `data`                    | DataFrame                                      | Panda dataframe containing target and explanatory candidates variables.                                                                                                                                                                                                                                                                      | `None`    |
| `target`                  | str                                            | Name of the column of data to be used as target.                                                                                                                                                                                                                                                                                             | `None`    |
| `select_vars`             | list                                           | List of variables to be crossed with target. If None (default), all variables will be used (except target).                                                                                                                                                                                                                                  | `None`    |
| `exclude_vars`            | list                                           | List of variables to be excluded for the analysis. Tyically id or text variables.                                                                                                                                                                                                                                                            | `None`    |
| `target_type`             | str                                            | If "auto", one will try to identify the nature of the target by using ``autoguess``.                                                                                                                                                                                                                                                         | `'auto'`  |
| `categorical_variables`   | (array - like or None, optional(default=None)) | List of variables numerical variables to be considered categorical. These are nominal variables.                                                                                                                                                                                                                                             | `'auto'`  |
| `description_data`        | str                                            | Will be stored in output object and used in report.                                                                                                                                                                                                                                                                                          | `None`    |
...
| `description_target`      | str                                            | Will be stored in output object and used in report.                                                                                                                                                                                                                                                                                          | `None`    |
| `num_as_categorical_nval` | int                                            | When (if) using ``autoguess``, all numeric variales having  ``num_as_categorical_nval`` or less distinct values will be considered  as categorical.                                                                                                                                                                                          | `5`       |
| `autoguess_nrows`         | int                                            | Number of rows of ``data`` to be used for variables nature automated guess.                                                                                                                                                                                                                                                                  | `1000`    |
| `metadata`                | pandas.pandas.DataFrame                        | DataFrame containing metadata to use labels in reports. DataFrame must contain at least 2 columns, one containing variable names (default  column name: "var", possibly changed using ``metadata_var`` parameter) and a second column containing the label (default name: "label").                                                          | `None`    |
| `metadata_var`            | str                                            | Name of the column that contains variables names in ``metadata`` DataFrame.                                                                                                                                                                                                                                                                  | `'var'`   |
| `metadata_label`          | str                                            | Name of the column that contains variables labels  in ``metadata`` DataFrame.                                                                                                                                                                                                                                                                | `'label'` |
| `include_missing`         | str                                            | Defines if report should display missing values category. If "always",  Missing will always be displayed in graphics (even if data does not contain any missing), if "never", Missing wil be removed (even if data does contain missing values). If "any", Missing category will be used if and only if there is at least one missing value. | `'any'`   |
| `include_special`         | str                                            | Similar to ``include_missing`` for ``OptBinning`` Special class.                                                                                                                                                                                                                                                                             | `'never'` |
...
| Name   | Type   | Description           | Default    |
|--------|--------|-----------------------|------------|
| `name` | str    | Name of the variable. | _required_ |
...
| `metric`          | (str, optional(default=woe)) | Supported metrics are "woe" to show the Weight of Evidence (WoE) measure and "event_rate" to show the event rate.  .. note::     Parameter ``metric`` has no effect for continuous targets. | `'event_rate'` |
| `add_special`     | bool(default=False)          | Whether to add the special codes bin.                                                                                                                                                       | `False`        |
| `add_missing`     | bool(default=True)           | Whether to add the special values bin.                                                                                                                                                      | `True`         |
| `style`           | (str, optional(default=bin)) | Plot style. style="bin" shows the standard binning plot. If style="actual", show the plot with the actual scale, i.e, actual bin widths.                                                    | `'bin'`        |
| `show_bin_labels` | bool(default=False)          | Whether to show the bin label instead of the bin id on the x-axis. For long labels (length > 27), labels are truncated.                                                                     | `True`         |
| `savefig`         | str or None(default=None)    | Path to save the plot figure.                                                                                                                                                               | `None`         |
...
| Name               | Type                         | Description                                                                                                                                                                                                                                                                                                                                   | Default     |
|--------------------|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| `out_directory`    | (str, optional(default='.')) | Output directory.                                                                                                                                                                                                                                                                                                                             | `'.'`       |
...
| Name   | Type   | Description       | Default    |
|--------|--------|-------------------|------------|
| `path` | str    | Pickle file path. | _required_ |
